      ...
      <Box mt={2} className="flex gap-4 w-full items-center justify-evenly">
        <Box className="w-full">
          ...
          <Box mt={2} className="flex flex-col gap-y-7">
            <Input label="Test Report 1" fullWidth />
            <Box>
              <Input
                label={
                  <span>
        ...
        <Box className="w-full">
          ...
          <Box mt={2} className="flex flex-col gap-y-7">
            <Input label="Test Report 2" fullWidth  />
            <Box>
              <Input
                label={
                  <span>
        ...
        <Box className="w-full">
          <Text className="bg-[#C967A226] text-[#C967A2] text-center !mb-[28px] rounded-lg ">ABG Test 3</Text>
          <Box mt={2} className="flex flex-col gap-y-7">
            <Input label="Test Report 3" fullWidth  />
            <Box>
              <Input
                label={
                  <span>
        ...
        <Box className="w-full">
          <Text className="bg-[#C967A226] text-[#C967A2] text-center !mb-[28px] rounded-lg ">ABG Test 4</Text>
          <Box mt={2} className="flex flex-col gap-y-7">
            <Input label="Test Report 4" fullWidth  />
            <Box>
              <Input
                label={
                  <span>
