...
const ApnoeaAllocation = () => {
  ...
  return (
    <Box className="bg-[#F8F8FF]">
      <Text className="text-[#804595]">Apnoea Details</Text>
      <Box mt={2} className="w-full flex gap-10">
        <Box className="flex w-full flex-col ">
          ...
          <Box mt={2} className="flex flex-wrap -mx-[24px]">
            ...
            <Box className="w-full md:w-1/2 px-[24px]  mb-[28px]">
              <Input label="Pre Apnoea ABG" fullWidth required />
            </Box>
            <Box className="w-full md:w-1/2 px-[24px]  mb-[28px]">
              <Input label="Post Apnoea ABG" fullWidth required />
            </Box>
          </Box>
        </Box>
        <Box className="flex w-full flex-col">
          ...
          <Box mt={2} className="flex flex-wrap -mx-[24px]">
            ...
            <Box className=" relative w-full md:w-1/2 px-[24px]  mb-[28px]">
              <Input label="Second Apnoea Date & Time" fullWidth required />
              <span className="absolute top-[10px] right-[35px]">
                <CalenderIcon />
              </span>
            </Box>
      ...
      <Box>
        <Text className="text-[#804595]">Consent Details</Text>
        <Box mt={2} className="flex flex-wrap -mx-[24px]">
          <Box className="w-full md:w-1/3 px-[24px]  mb-[28px]">
            <AtomRadioGroup label="Consent Given" isRequired={true} row>
              {data.radioOption.map((item, index) => (
                <AtomRadio
                  key={index}
                  value={item.value}
        ...
        <Box mt={2} className="flex flex-wrap -mx-[24px]">
          ...
          {written && (
            <Box className={`w-full ${!consent ? 'hidden' : ''} md:w-1/3 px-[24px]  mb-[28px]`}>
              <Input label="Written Consent" fullWidth required />
            </Box>
          )}
          {audio && (
            <Box className={`w-full ${!consent ? 'hidden' : ''} md:w-1/3 px-[24px]  mb-[28px]`}>
              <Input label="Audio Consent" fullWidth />
            </Box>
          )}
          {video && (
            <Box className={`w-full ${!consent ? 'hidden' : ''} md:w-1/3 px-[24px]  mb-[28px]`}>
              <Input label="Video Consent" fullWidth />
            </Box>
          )}
        </Box>
      </Box>
