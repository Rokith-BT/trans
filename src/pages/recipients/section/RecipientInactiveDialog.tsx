...
interface InactiveDialogProps {
  ...
  onInactive: (val: string) => void;
  // eslint-disable-next-line no-unused-vars
  setReason: Dispatch<SetStateAction<string>>;
  validation: string;
}

const RecipientInactiveDialog: React.FC<InactiveDialogProps> = ({
  open,
  onClose,
  data,
  onInactive,
      ...
      <Box>
        <Box>
          <Text className="!text-[#A1999F] !mb-4 !text-[16px] !font-[500]">
            Are You Sure, Do You want to <span className="!text-[#1A0616] !font-[500] !text-[16px]">Inactive</span>?
          </Text>
...
export default RecipientInactiveDialog;
