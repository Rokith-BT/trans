...
public class AbhaLinkResponse {
    ...
    @SerializedName("verified_abha_address")
    @Expose
    private String verifiedAbhaAddress;
    ...
    public String getVerifiedAbhaAddress() {
        return verifiedAbhaAddress;
    }

    public void setVerifiedAbhaAddress(String verifiedAbhaAddress) {
        this.verifiedAbhaAddress = verifiedAbhaAddress;
    }
    public class Detail {
